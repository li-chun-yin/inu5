...
class Television_IndexController extends In_controller
{
	...
	{
		$html_file = ROOT_PATH."/pages/index.html";
		if(parent::check_html_file($html_file,'3600*24')){	echo file_get_contents($html_file); exit;}
		/**********************VAR DATA*************************************/
